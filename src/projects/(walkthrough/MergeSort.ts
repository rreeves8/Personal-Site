//not code I made, Pretty sure sam weller made this

function generateArray(length: number, min: number, max: number) {
    let outputArr = [];
...
function merge(arr1: string | any[], arr2: string | any[]) {
...
// of arr to be sorted */
function mergeSort(arr: string | any[], l: number, r: number) {
...
function MergeSort(size: any, range: any) {
    steps = [];
