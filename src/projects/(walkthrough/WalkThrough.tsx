...
function ArrayHolder(props: { children: React.ReactNode }) {
    return <div style={{ display: "flex", gap: "10px" }}>{props.children}</div>;
}
...
const AnimationElement = (props: { children: React.ReactNode; play: boolean; colorOld: string; transition: Transition; colorNew: string }) => {
    ...
    return <animated.div style={{ ...animateProps, flexDirection: "row" }}>{props.children}</animated.div>;
};
        ...
        <div style={{ flexDirection: "row", display: "flex" }}>
            {props.sorted
                ? []
                      ...
                      .map((element: number, i: number) => {
                          return (
                              ...
                              >
                                  <Button style={{ fontWeight: "bolder", color: "black" }} disabled={true} variant="outlined">
                                      {" "}
                                      {element}
                                  </Button>
                              </AnimationElement>
                ...
                : numArray[1].map((element: number) => {
                      return (
                          <Button style={{ backgroundColor: props.color, fontWeight: "bolder", color: "black" }} disabled={true} variant="outlined">
                              {" "}
                              {element}
                          </Button>
                      );
...
const ArrayComp = (props: {
    ...
    let arrComp = [
        <AnimationBar play={!flipSorted(1) && counter === 1}>
            <Cell
                key={0}
                side={props.side}
                counter={counter}
                play={props.playRoot}
                color="#ff5b5b"
                numArray={numArray[values[0]]}
                sorted={flipSorted(1)}
            />
        </AnimationBar>,

        <AnimationBar play={!flipSorted(2) && counter === 2}>
            <ArrayHolder key={1}>
                <Cell
                    key={2}
                    side="left"
                ...
                <Cell
                    ...
                    play={flipSorted(2) && counter === 2}
                    color="#ff5b5b"
                    numArray={numArray[values[2]]}
                    sorted={flipSorted(2)}
                />
            </ArrayHolder>
        </AnimationBar>,

        <AnimationBar play={!flipSorted(3) && counter === 3}>
            <ArrayHolder key={4}>
                <ArrayHolder key={5}>
                    <Cell
                        key={6}
                ...
                >
                    <Button key={9} style={{ backgroundColor: "#ff5b5b", fontWeight: "bolder", color: "black" }} disabled={true} variant="outlined">
                        {" "}
                        {numArray[values[2]][1][0]}
                    </Button>
                </AnimationElement>
                <AnimationElement
                    key={10}
                ...
                >
                    <Button key={11} style={{ fontWeight: "bolder", color: "black" }} disabled={true} variant="outlined">
                        {" "}
                        {numArray[values[2]][1][1]}
                    </Button>
                </AnimationElement>
            </ArrayHolder>
        </AnimationBar>,
        <AnimationBar play={!flipSorted(4) && counter === 4}>
            <ArrayHolder key={12}>
                <AnimationElement
                    key={13}
                    play={counter === 4}
                ...
                >
                    <Button key={16} style={{ fontWeight: "bolder", color: "black", backgroundColor: "#ff5b5b" }} disabled={true} variant="outlined">
                        {" "}
                        {numArray[values[5]][1][0]}
                    </Button>
                </AnimationElement>
                <AnimationElement
                    key={14}
                ...
                >
                    <Button key={15} style={{ fontWeight: "bolder", color: "black" }} disabled={true} variant="outlined">
                        {" "}
                        {numArray[values[6]][1][0]}
                    </Button>
                </AnimationElement>
            </ArrayHolder>
        </AnimationBar>,
...
const IncrementButton = (props: { increaseCounter: () => void }) => {
    ...
    return (
        <Button
            onClick={() => {
                if (!isAnimating) props.increaseCounter();
            }}
            variant="contained"
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                    ...
                    {this.state.doneSorting ? (
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                            <text style={{ fontSize: "x-large", fontFamily: "Brandon Grotesque Regular, sans-serif" }}>Complete!</text>
                        </div>
                    ) : (
                        <div>
                            <div
                            ...
                            <IncrementButton increaseCounter={this.increaseCounter} />
                        </div>
                    )}
                </div>
            </WalkThroughProvider>
...
const AnimationBar = (props: { children: React.ReactNode; play: boolean }) => {
    ...
    return <animated.div style={{ ...animateProps }}>{props.children}</animated.div>;
};
